      ...
      <div className="container relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            <span className="bg-gold-gradient bg-clip-text text-transparent">Performance & Drawdown</span>
          </h2>
          <p className="text-white/80 max-w-2xl mx-auto text-lg">
            In backtests and real-time simulations, AGT EA has demonstrated the ability to generate consistent profits with minimal drawdown
          </p>
        </div>
        
        <div className="bg-navy-light/30 backdrop-blur-sm border border-gold/10 rounded-xl p-6 mb-10">
          <h3 className="text-gold text-xl font-semibold mb-4">Account Growth Over Time</h3>
          <div className="h-80">
        ...
        <div className="mt-16 text-center">
          <p className="text-white/80 max-w-2xl mx-auto">
            Even in volatile market conditions, the EA performs effectively thanks to its news filter and recovery mechanisms. Drawdowns are well-controlled, with losses being offset in short timeframes.
          </p>
        </div>
      </div>
    </section>
